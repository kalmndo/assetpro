...
export const AddDialog = ({ data }: Props) => {
  ...
  const { mutateAsync, isPending } = api.mbSubSubKategori.create.useMutation()
  ...
  async function onSubmit(values: any) {
    ...
    try {
      ...
      const classCode = `${golCode!.code}.${katCode!.code}.${subKatCode!.code}`
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent >
        <DialogHeader>
          <DialogTitle>Tambah Sub Sub Kategori</DialogTitle>
        </DialogHeader>
        <Form
          data={data}
          isPending={isPending}
