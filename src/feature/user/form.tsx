...
const items: Items[] = [
  ...
  ROLE.PERBAIKAN_EKSTERNAL_APPROVE,
  ...
  ROLE.PEMINJAMAN_EKSTERNAL_CREATE,
  ROLE.PEMINJAMAN_EKSTERNAL_APPROVE,
  ROLE.PEMINJAMAN_EKSTERNAL_SEND_TO_USER,
  ROLE.PEMINJAMAN_EKSTERNAL_RECEIVE_FROM_USER,
  {
    separator: true
  },
  ROLE.MASTER_VIEW,
